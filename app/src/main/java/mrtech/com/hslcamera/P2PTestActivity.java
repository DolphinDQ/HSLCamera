...
public class P2PTestActivity extends AppCompatActivity implements View.OnClickListener {

    private ArrayAdapter<String> testListAdapter;
    private P2PConectionTask p2pConnectionTask;
    private Handler handler;

    private  String p2pId = "umkss83g7brx";
...
//        initData();
    ...
    private void initView() {
        ...
        testListAdapter = new ArrayAdapter<>(this, android.R.layout.simple_expandable_list_item_1, new ArrayList<String>());
    ...
    private void startTask() {
        stopTask();
        p2pId= ((EditText)findViewById(R.id.sn_txt)).getText().toString();
